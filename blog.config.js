...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || 'ec78782227e64eef9dbec228d5e3f0f2',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Fri', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-eta-azure.vercel.app/', // 网站地址
